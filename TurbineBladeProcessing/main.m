...
i=7;
    ...
    shape.Alpha = 0.01; 
    %This Alpha value seems to work okay, but need to verify for each
    %individual airfoil cross section just in case. 
    ...
    t_fine = 1:0.2:length(x);  % Finer spacing
    ...
    [bf,offsetPoints] = boundaryFacets(offsetShape);
    figure(7);
